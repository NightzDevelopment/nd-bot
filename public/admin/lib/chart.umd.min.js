...
!((t, e) => {
  ...
  function _(t, e, i) {
    ...
    const s = e[t],
      n = i[t]
    o(s) && o(n) ? x(s, n) : Object.hasOwn(e, t) || (e[t] = g(n))
  }
  ...
  const ht = 'undefined' == typeof window ? (t) => t() : window.requestAnimationFrame
  function ct(t, e) {
    let i = [],
      s = !1
    return (...n) => {
  ...
  function It(t) {
    ...
    return (
      n !== o &&
        ...
        (r = ((t, e, i, s, n) =>
          t === n ? (e - i) / s + (e < i ? 6 : 0) : e === n ? (i - t) / s + 2 : (t - e) / s + 4)(
          e,
          i,
          s,
          h,
  ...
  function Bt(t) {
    ...
    return (
      (i =
        'hwb' === e[1]
          ? ((t, e, i) => zt(Rt, t, e, i))(n, o, a)
          : 'hsv' === e[1]
            ? ((t, e, i) => zt(Et, t, e, i))(n, o, a)
            : Ft(n, o, a)),
  ...
  const Yt = (t) => (t <= 0.0031308 ? 12.92 * t : 1.055 * t ** (1 / 2.4) - 0.055),
    Ut = (t) => (t <= 0.04045 ? t / 12.92 : ((t + 0.055) / 1.055) ** 2.4)
  function Xt(t, e, i) {
    if (t) {
      let s = It(t)
  ...
  const oe = {
    ...
    logarithmic(t, e, i) {
      if (0 === t) return '0'
      const s = i[e].significand || t / 10 ** Math.floor(z(t))
  ...
  const ci = (t) => 0 === t || 1 === t,
    di = (t, e, i) => -(2 ** (10 * (t -= 1))) * Math.sin(((t - e) * O) / i),
    ui = (t, e, i) => 2 ** (-10 * t) * Math.sin(((t - e) * O) / i) + 1,
    fi = {
      linear: (t) => t,
      easeInQuad: (t) => t * t,
      easeOutQuad: (t) => -t * (t - 2),
      ...
      easeInOutExpo: (t) =>
        ci(t) ? t : t < 0.5 ? 0.5 * 2 ** (10 * (2 * t - 1)) : 0.5 * (2 - 2 ** (-10 * (2 * t - 1))),
  ...
  function Bi(t, e) {
    if (!e) return !1
    const i = [],
      s = (t, e) => (Jt(e) ? (i.includes(e) || i.push(e), i.indexOf(e)) : e)
  ...
  class Js extends Hs {
    ...
    getContext(t) {
      ...
      if (t >= 0 && t < e.length) {
        ...
        return (
          i.$context ||
          (i.$context = ((t, e, i) => Ci(t, { tick: i, index: e, type: 'tick' }))(
            this.getContext(),
            t,
            i,
          ))
  ...
  class bn {
    constructor(t) {
      ;(this._config = ((t) => (((t = t || {}).data = un(t.data)), dn(t), t))(t)),
  ...
  class An {
    ...
    _handleEvent(t, e, i) {
      const { _active: s = [], options: n } = this,
        ...
        r = D(t),
        l = ((t, e, i, s) => (i && 'mouseout' !== t.type ? (s ? e : t) : null))(
          t,
          this._lastEvent,
          i,
          r,
    ...
    BarController: class extends Ns {
      ...
      _calculateBarValuePixels(t) {
        ...
        if (
          ...
          ;(u =
            ((t, e, i) => (0 !== t ? F(t) : (e.isHorizontal() ? 1 : -1) * (e.min >= i ? 1 : -1)))(
              u,
              e,
              r,
            ) * a),
  ...
  function Qn(t, e, i, s) {
    const { points: n, options: o } = e,
      ...
      c = ((t) =>
        t.stepped ? Fe : t.tension || 'monotone' === t.cubicInterpolationMode ? Ve : Zn)(o)
    let d,
      u,
      f,
  ...
  class no extends Hs {
    ...
    interpolate(t, e) {
      ...
      const a = [],
        r = ((t) =>
          t.stepped ? pi : t.tension || 'monotone' === t.cubicInterpolationMode ? mi : gi)(i)
      let l, h
  ...
  class bo extends Js {
    ...
    buildTicks() {
      ...
      const n = ((t, e) => {
        ...
        ;(v = 10 ** (s(l) ? P : l)), (M = Math.round(M * v) / v), (w = Math.round(w * v) / v)
        let D = 0
        for (
          b &&
          (u && M !== a
  ...
  function wo(t, { min: e, max: i }) {
    ...
    let u = Math.floor((c - d) / 10 ** o),
      f = r(t.min, Math.round((h + d + u * 10 ** o) * a) / a)
    for (; f < i; )
      s.push({ value: f, major: vo(f), significand: u }),
        u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
        u >= 20 && (o++, (u = 2), (a = o >= 0 ? 1 : a)),
        (f = Math.round((h + d + u * 10 ** o) * a) / a)
    const g = r(t.max, f)
  ...
  class Eo extends bo {
    ...
    getPointLabelContext(t) {
      ...
      if (t >= 0 && t < e.length) {
        const i = e[t]
        return ((t, e, i) => Ci(t, { label: i, index: e, type: 'pointLabel' }))(
          this.getContext(),
          t,
          i,
        )
  ...
  function qo(t) {
    ...
    return (i, s) => {
      ...
      n instanceof jn
        ? (e = ((t, e) => ((t.backgroundColor = t.data.map(() => Uo(e++))), e))(i, e))
        : n instanceof $n
          ? (e = ((t, e) => ((t.backgroundColor = t.data.map(() => Xo(e++))), e))(i, e))
          : n && (e = ((t, e) => ((t.borderColor = Uo(e)), (t.backgroundColor = Xo(e)), ++e))(i, e))
    }
  }
  function Ko(t) {
    let e
