...
const HELP: Readonly<Record<string, string>> = {
  ...
  ALT_DETECTION_ENABLED: 'Score new joins for ban-evasion signals and alert staff (1/0).',
  ALT_ALERT_THRESHOLD: 'Risk score (1-7) at or above which an alt alert is posted.',
...
const TAB_RULES: readonly TabRule[] = [
  ...
  { match: (k) => k.startsWith('AI_AUTOMOD_'), tab: 'AI AutoMod' },
